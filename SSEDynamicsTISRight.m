function [outPath, outPsi, idx_new, check, Tran, etaUsed] = SSEDynamicsTISRight(PsiIn, dt, tf, Hhat, Lhat, Rhat, hbar, A, B)
    % This function simulates the dynamics of a quantum system based on the stochastic Schrödinger equation for TIS.
    % Inputs:
    ...
    %   A, B   - Boundaries for path evaluation
    % Outputs:
    ...
    Tran = 0; % Indicator of transition
