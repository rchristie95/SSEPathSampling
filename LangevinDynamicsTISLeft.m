function [outPath, outZ, idx_new, check, etaUsed] = LangevinDynamicsTISLeft(ZIn, dt, tf, Gamma, Temp, h4, h2, A)
    % This function simulates the Langevin dynamics for a system with a left boundary A.
    % Inputs:
    ...
    for n = 2:N-1 % Backward evolution loop
        ...
        % Check if trajectory reached boundary A
        if Zb(1, n) >= A
            Sb = 1;
            break;
        end
